...
#ifndef SUPERMAN_REBORN_PARALLELSKIPPERMANBALANCED_H
#define SUPERMAN_REBORN_PARALLELSKIPPERMANBALANCED_H
...
class ParallelSkipPermanBalanced: public Permanent<C, S>
{
public:
    ParallelSkipPermanBalanced(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double ParallelSkipPermanBalanced<C, S>::permanentFunction()
{
...
#endif //SUPERMAN_REBORN_PARALLELSKIPPERMANBALANCED_H
