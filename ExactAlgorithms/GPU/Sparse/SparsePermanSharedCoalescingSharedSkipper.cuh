...
#ifndef SUPERMAN_REBORN_SPARSEPERMANSHAREDCOALESCINGSHAREDSKIPPER_CUH
#define SUPERMAN_REBORN_SPARSEPERMANSHAREDCOALESCINGSHAREDSKIPPER_CUH
...
class SparsePermanSharedCoalescingSharedSkipper: public Permanent<C, S>
{
public:
    SparsePermanSharedCoalescingSharedSkipper(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double SparsePermanSharedCoalescingSharedSkipper<C, S>::permanentFunction()
{
    ...
    Definitions::kernel_xshared_coalescing_mshared_skipper<C,S><<<grid_dim , block_dim , size>>>(d_rptrs, d_cols, d_cptrs, d_rows, d_cvals, d_x, d_p, nov, total, start, end);
    cudaDeviceSynchronize();
...
#endif //SUPERMAN_REBORN_SPARSEPERMANSHAREDCOALESCINGSHAREDSKIPPER_CUH
