...
#ifndef SUPERMAN_REBORN_PERMANSHARED_CUH
#define SUPERMAN_REBORN_PERMANSHARED_CUH
...
class PermanShared: public Permanent<C, S>
{
public:
    PermanShared(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanShared<C, S>::permanentFunction()
{
    ...
    cudaOccupancyMaxPotentialBlockSizeVariableSMem(&grid_dim,
                                                   &block_dim,
                                                   &Definitions::kernel_xshared<C,S>,
                                                   xshared_sharedmem,
                                                   0);
    ...
    Definitions::kernel_xshared<C,S><<<grid_dim , block_dim , size>>> (d_mat_t, d_x, d_p, nov);
    cudaDeviceSynchronize();
...
#endif //SUPERMAN_REBORN_PERMANSHARED_CUH
