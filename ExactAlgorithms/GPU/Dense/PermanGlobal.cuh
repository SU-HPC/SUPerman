...
#ifndef SUPERMAN_REBORN_PERMANGLOBAL_CUH
#define SUPERMAN_REBORN_PERMANGLOBAL_CUH
...
class PermanGlobal: public Permanent<C, S>
{
public:
    PermanGlobal(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanGlobal<C, S>::permanentFunction()
{
    //Pack parameters
    ...
    cudaOccupancyMaxPotentialBlockSize(&grid_dim,
                                       &block_dim,
                                       &Definitions::kernel_xglobal<C,S>,
                                       0,
                                       0);
    */
    ...
    Definitions::kernel_xglobal<C, S><<<grid_dim, block_dim>>>(d_mat_t, d_x, d_p, nov);
    cudaDeviceSynchronize();
...
#endif //SUPERMAN_REBORN_PERMANGLOBAL_CUH
