...
#ifndef SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXTEXFOUR_CUH
#define SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXTEXFOUR_CUH
...
class PermanSharedCoalescingPlainMatrixTexfour: public Permanent<C, S>
{
public:
    PermanSharedCoalescingPlainMatrixTexfour(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanSharedCoalescingPlainMatrixTexfour<C, S>::permanentFunction()
{
    ...
    Definitions::kernel_xshared_coalescing_plainmatrix_texfour<C,S><<<grid_dim , block_dim , size>>> (d_mat_t, d_x, d_p, nov);
    cudaDeviceSynchronize();
...
#endif //SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXTEXFOUR_CUH
