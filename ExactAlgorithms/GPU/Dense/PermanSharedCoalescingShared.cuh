...
#ifndef SUPERMAN_REBORN_PERMANSHAREDCOALESCINGSHARED_CUH
#define SUPERMAN_REBORN_PERMANSHAREDCOALESCINGSHARED_CUH
...
class PermanSharedCoalescingShared: public Permanent<C, S>
{
public:
    PermanSharedCoalescingShared(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanSharedCoalescingShared<C, S>::permanentFunction()
{
    //Pack parameters//
...
#endif //SUPERMAN_REBORN_PERMANSHAREDCOALESCINGSHARED_CUH
