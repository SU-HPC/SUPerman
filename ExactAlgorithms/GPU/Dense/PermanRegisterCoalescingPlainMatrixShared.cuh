...
#ifndef SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHARED_CUH
#define SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHARED_CUH
...
class PermanRegisterCoalescingPlainMatrixShared: public Permanent<C, S>
{
public:
    PermanRegisterCoalescingPlainMatrixShared(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanRegisterCoalescingPlainMatrixShared<C, S>::permanentFunction()
{
    //Pack parameters//
    ...
    cudaOccupancyMaxPotentialBlockSizeVariableSMem(&grid_dim,
                                                   &block_dim,
                                                   &Definitions::kernel_xregister_coalescing_plainmatrix_mshared<C,S>,
...
#endif //SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHARED_CUH
