...
#ifndef SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIX_CUH
#define SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIX_CUH

#include "Permanent.h"


template <class C, class S>
class PermanSharedCoalescingPlainMatrix: public Permanent<C, S>
{
public:
    PermanSharedCoalescingPlainMatrix(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanSharedCoalescingPlainMatrix<C, S>::permanentFunction()
{
    ...
    Definitions::kernel_xshared_coalescing_plainmatrix<C,S><<<grid_dim , block_dim , size>>> (d_mat_t, d_x, d_p, nov);
    cudaDeviceSynchronize();
...
#endif //SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIX_CUH
