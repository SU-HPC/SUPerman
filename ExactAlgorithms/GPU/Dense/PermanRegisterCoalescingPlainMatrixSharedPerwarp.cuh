...
#ifndef SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
#define SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
...
class PermanRegisterCoalescingPlainMatrixSharedPerWarp: public Permanent<C, S>
{
public:
    PermanRegisterCoalescingPlainMatrixSharedPerWarp(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanRegisterCoalescingPlainMatrixSharedPerWarp<C, S>::permanentFunction()
{
    //Pack parameters//
...
#endif //SUPERMAN_REBORN_PERMANREGISTERCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
