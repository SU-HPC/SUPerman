...
#ifndef SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
#define SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
...
class PermanSharedCoalescingPlainMatrixSharedPerWarp: public Permanent<C, S>
{
public:
    PermanSharedCoalescingPlainMatrixSharedPerWarp(Matrix<S>* matrix, Settings settings)
...
template<class C, class S>
double PermanSharedCoalescingPlainMatrixSharedPerWarp<C, S>::permanentFunction()
{
    //Pack parameters//
...
#endif //SUPERMAN_REBORN_PERMANSHAREDCOALESCINGPLAINMATRIXSHAREDPERWARP_CUH
